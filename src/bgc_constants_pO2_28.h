...
#define P_STD    111148.6        /* (Pa) standard pressure at 0.0 m elevation */
#define T_STD    288.15          /* (K) standard temp at 0.0 m elevation  */
#define MA       29.028e-3      /* (kg/mol) molecular weight of air */
#define MW       18.0148e-3      /* (kg/mol) molecular weight of water */
#define CP       932.73         /* (J/kg K) specific heat of air */
...
#define EPS      0.578          /* (MW/MA) unitless ratio of molec weights */
#define pO2      0.28           /* (%) atmospheric oxygen concentration */
#define d13Ca    -8.0           /* (‰) carbon isotope discimination of the atmosphere */
